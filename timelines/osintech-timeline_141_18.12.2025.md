...
```Device Activity Tracker```. A phone number can reveal whether a device is active, in standby or offline (and more). This PoC demonstrates how delivery receipts + RTT timing leak sensitive device-activity patterns. (WhatsApp / Signal): https://github.com/gommzystudio/device-activity-tracker
