...
• Visualize logon data with Neo4j & Cytoscape  
• Install with Docker for easy setup  
• Detailed event log analysis in chronological order  
• Use advanced algorithms to pinpoint suspicious activity
