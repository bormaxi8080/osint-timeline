...
```Telegram Automation & Safety Tool```. Telegram automation utility built with Telethon, designed for username validation, group member extraction, and controlled message sending with built-in anti-spam safety, rate limiting, and randomized delays: https://github.com/r0otk3r/telegram-tool
