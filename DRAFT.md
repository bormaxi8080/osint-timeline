...
Profanity Filtering. Super fast profanity filter supporting 107 languages. 22,800+ profanity words across all languages. Zero runtime dependencies. Set-based O(1) word lookups. TypeScript-first with full type declarations. ESM + CommonJS dual export: https://github.com/Wart050/Profanity-Filtering-All-languages
...
Call.md. Turn meetings into live agent loops. Record, transcribe, and analyze meetings with real-time AI intelligence - before, during, and after calls: https://github.com/video-db/call.md
